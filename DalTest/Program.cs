...
//            var volunteer = new Volunteer { ID = id, Name = name, BirthDate = birthDate };
...
//        {
//            Console.WriteLine("Call submenu - CRUD functionality:");
//            // Add your implementation here
//        }

//        private static void ShowAssignmentSubmenu()
//        {
//            Console.WriteLine("Assignment submenu - CRUD functionality:");
//            // Add your implementation here
//        }

//        private static void ShowConfigSubmenu()
//        {
//            Console.WriteLine("Config submenu - System settings:");
//            // Add your implementation here
//        }
//    }
//}
    ...
    internal class Program
    {
        ...
        private static void UpdateVolunteer()
        {
            ...
            if (volunteer != null)
            {
                ...
                if (!string.IsNullOrEmpty(newName))
                {
                    volunteer = volunteer with { name = newName }; // שימוש בתכונה "with" כדי ליצור עותק מעודכן
                }
